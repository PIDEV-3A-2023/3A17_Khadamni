 ...
 */
final class Version20230423210753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_reclamation CHANGE id_reclamation id_reclamation INT DEFAULT NULL, CHANGE etat_reclamation etat_reclamation VARCHAR(45) NOT NULL, CHANGE sujet sujet VARCHAR(255) NOT NULL, CHANGE motif motif VARCHAR(255) NOT NULL, CHANGE avis avis VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE suivi_reclamation CHANGE id_reclamation id_reclamation INT NOT NULL, CHANGE etat_reclamation etat_reclamation VARCHAR(45) DEFAULT NULL, CHANGE sujet sujet VARCHAR(255) DEFAULT NULL, CHANGE motif motif VARCHAR(255) DEFAULT NULL, CHANGE avis avis VARCHAR(255) DEFAULT NULL');
